...
//    var authState: OIDAuthState?
    ...
    private let kKeychainItemName = "RegionDrivefor"
    ...
    private let kScriptID = "M58lyYAeRJqwAPeDN7X7aP6qvqV2VSo87"
    
    private let kIssuer = "https://accounts.google.com"
    
    private let scopes = [kGTLAuthScopeCalendarReadonly, "https://www.googleapis.com/auth/drive", "https://www.googleapis.com/auth/spreadsheets"]
