...
SWIFT_CLASS("_TtC14RegionDrivefor11AppDelegate")
...
SWIFT_CLASS("_TtC14RegionDrivefor14ViewController")
...
@property (nonatomic, copy) NSArray<NSDictionary *> * _Nonnull getBeaconList;
...
- (void)viewControllerWithVc:(UIViewController * _Nonnull)vc finishedWithAuth:(GTMOAuth2Authentication * _Nonnull)authResult error:(NSError * _Nullable)error;
...
- (void)sendLocalNotificationWithMessageWithMessage:(NSString * _Nonnull)message;
